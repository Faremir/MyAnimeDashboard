/**
 * Supported sort directions for repository query results.
 */
export type SortDirection = 'asc' | 'desc';

/**
 * Normalizes user-entered search text before filtering records.
 */
...
/**
 * Compares display strings using locale-aware, numeric-aware ordering.
 */
...
/**
 * Compares numbers with the same direction contract used by repository sorts.
 */
...
/**
 * Compares dates by timestamp with the same direction contract used by repository sorts.
 */
