...
<section class="page">
    ...
    <div class="dashboard-grid">
        <a
            ...
            href={navigationRepository.getNavigationHref(librarySection)}
            onclick={(event) => openSection(event, librarySection)}>
        ...
        <a
            ...
            href={navigationRepository.getNavigationHref(scheduleSection)}
            onclick={(event) => openSection(event, scheduleSection)}>
            <header class="card-header">
                <div>
        ...
        <a
            ...
            class="surface clickable-surface dashboard-card"
            href={navigationRepository.getNavigationHref(settingsSection)}
            onclick={(event) => openSection(event, settingsSection)}>
            <header class="card-header">
                <div>
